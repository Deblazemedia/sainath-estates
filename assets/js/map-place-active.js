    ...
    var LocsA = [
        {
            ...
            html: [ '<div class="single-location bg-theme">',
                        '<thumb class="thumb">',
                            '<a href="property-details.html"><img src="assets/img/property/property_inner_1.jpg" loading="lazy" alt="img"></a>',
                        ...
                        '<div class="media-body">',
                            ...
                            '<a class="location" href="property-details.html"><span class="icon"><img src="assets/img/icon/location-dot.svg" loading="lazy" alt="Shop No. 2, Evershine Embassy CHS Ltd, Veera Desai Road, Andheri
                                                    West,
                                                    Mumbai - 400053."></span>Brooklyn, New York 11233, United States</a>',
                            '<div class="property-card-meta">',
                                '<span><img src="assets/img/icon/property-icon1-1.svg" loading="lazy" alt="img">Bed 4</span>',
                                '<span><img src="assets/img/icon/property-icon1-2.svg" loading="lazy" alt="img">Bath 2</span>',
                                '<span><img src="assets/img/icon/property-icon1-3.svg" loading="lazy" alt="img">1500 sqft</span>',
                            '</div>',
                        '</div>',
                    '</div>'
                ].join(''),
        ...
        },
        {
            ...
            html: [ '<div class="single-location bg-theme">',
                        '<thumb class="thumb">',
                            '<a href="property-details.html"><img src="assets/img/property/property_inner_3.jpg" loading="lazy" alt="img"></a>',
                            '<div class="property-card-tag">Residence</div>',
                        '</thumb>',
                        '<div class="media-body">',
        ...
        },
        {
            ...
            html: [ '<div class="single-location bg-theme">',
                        '<thumb class="thumb">',
                            '<a href="property-details.html"><img src="assets/img/property/property_inner_7.jpg" loading="lazy" alt="img"></a>',
                            '<div class="property-card-tag">Residence</div>',
                        '</thumb>',
                        '<div class="media-body">',
        ...
        },
        {
            ...
            html: [ '<div class="single-location bg-theme">',
                        '<thumb class="thumb">',
                            '<a href="property-details.html"><img src="assets/img/property/property_inner_4.jpg" loading="lazy" alt="img"></a>',
                            '<div class="property-card-tag">Residence</div>',
                        '</thumb>',
                        '<div class="media-body">',
        ...
        },
        {
            ...
            html: [ '<div class="single-location bg-theme">',
                        '<thumb class="thumb">',
                            '<a href="property-details.html"><img src="assets/img/property/property_inner_6.jpg" loading="lazy" alt="img"></a>',
                            '<div class="property-card-tag">Residence</div>',
                        '</thumb>',
                        '<div class="media-body">',
